...
const file_transport_internet_tls_config_proto_rawDesc = "" +
	...
	"\x0fAUTHORITY_ISSUE\x10\x02\"\xe9\a\n" +
	"\x06Config\x12%\n" +
	...
	"\x19verify_peer_cert_in_names\x18\x11 \x03(\tR\x15verifyPeerCertInNames\x12&\n" +
	...
	"\x13ech_socket_settings\x18\x15 \x01(\v2%.xray.transport.internet.SocketConfigR\x11echSocketSettingsBs\n" +
