...
const file_transport_internet_headers_dns_config_proto_rawDesc = "" +
	"\n" +
	"+transport/internet/headers/dns/config.proto\x12#xray.transport.internet.headers.dns\" \n" +
	"\x06Config\x12\x16\n" +
	"\x06domain\x18\x01 \x01(\tR\x06domainB\x8b\x01\n" +
...
var (
	...
	file_transport_internet_headers_dns_config_proto_rawDescData []byte
)
...
func file_transport_internet_headers_dns_config_proto_rawDescGZIP() []byte {
	file_transport_internet_headers_dns_config_proto_rawDescOnce.Do(func() {
		file_transport_internet_headers_dns_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_transport_internet_headers_dns_config_proto_rawDesc), len(file_transport_internet_headers_dns_config_proto_rawDesc)))
	})
...
func file_transport_internet_headers_dns_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_transport_internet_headers_dns_config_proto_rawDesc), len(file_transport_internet_headers_dns_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
